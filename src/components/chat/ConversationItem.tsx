    ...
    >
      ...
      {editing ? (
        <input
          ...
          className="flex-1 min-w-0 bg-background border border-input rounded px-1.5 py-0.5 text-sm outline-none focus:ring-2 focus:ring-ring"
        />
      ) : (
        <span className="flex-1 truncate" title="Bấm đôi để đổi tên">
          {conversation.title}
        </span>
      )}
      {!editing && (
